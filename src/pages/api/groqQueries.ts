...
export const groqQueries: Record<string, string> = {
    ...
    otherMedias: groq`*[_type == "otherMedia"]{component->{name, page}, headTitle, arrowIcon->,medias[] {name, mainUrl, text, image->{..., "aspect": image.asset->metadata.dimensions.aspectRatio}, contained ,useArrow, socialNetworks[] {name, icon->, url}}}[0]`,
